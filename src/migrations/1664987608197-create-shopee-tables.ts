...
export class createShopeeTables1664987608197 implements MigrationInterface {
    name = 'createShopeeTables1664987608197'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."shopee_order_synchronization_status_enum" AS ENUM('pending', 'failed', 'successful')`);
        await queryRunner.query(`CREATE TABLE "shopee_order_synchronization" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "shop_id" character varying NOT NULL, "status" "public"."shopee_order_synchronization_status_enum" NOT NULL DEFAULT 'pending', CONSTRAINT "UQ_92c1f8985e4003939b9ddc81687" UNIQUE ("id"), CONSTRAINT "PK_92c1f8985e4003939b9ddc81687" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "shopee_order_synchronization" ADD CONSTRAINT "FK_eb0305924d83e871a4ecc54423e" FOREIGN KEY ("shop_id") REFERENCES "shopee_shop"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "shopee_order_synchronization" DROP CONSTRAINT "FK_eb0305924d83e871a4ecc54423e"`);
        ...
        await queryRunner.query(`DROP TABLE "shopee_order_synchronization"`);
        await queryRunner.query(`DROP TYPE "public"."shopee_order_synchronization_status_enum"`);
