...
export class ProductsService extends TokensService {
  ...
  async addItem(dto: AddItemsBodyDto & { shopId: string }) {
    ...
    const body = {
      ...
      ...(dto.preOrder && {
        pre_order: {
          is_pre_order: dto.preOrder.isPreOrder,
          days_to_ship: dto.preOrder.dayToShip,
        },
      }),
      ...
      ...(dto.complaintPolicy && {
        complaint_policy: {
          ...
          ...(dto.complaintPolicy.complaintAddressId && {
            complaint_address_id: dto.complaintPolicy.complaintAddressId,
          }),
          ...(dto.complaintPolicy.additionalInformation && {
            additional_information: dto.complaintPolicy.additionalInformation,
          }),
        },
      }),
      ...(dto.descriptionInfo && {
